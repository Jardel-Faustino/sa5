...
def cadastrar (request):
    ...
    return render(request, 'gtc_app/rotas/cadastrar.html', {'pagina_ativa': 'cadastrar','paises': paises})  # Renderiza o template 'cadastrar.html' com o formulário e passando 'paises' para o contexto do template
...
def salvos(request):
    ...
    if nome_pesquisado:
        usuarios = usuario.objects.filter(nome=nome_pesquisado)
